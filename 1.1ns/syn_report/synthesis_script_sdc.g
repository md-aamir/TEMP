...
# Created by Encounter(R) RTL Compiler RC14.25 - v14.20-s046_1 on Sun May 03 03:06:40 +0530 2020

# This file contains the RC script for /designs/project_top

######################################################################

set_attribute -quiet runtime_by_stage { {global_incr_map 1 14 0 11}  {incr_opt 1 15 0 12} } /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 1100.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -design /designs/project_top /designs/project_top/ports_in/clk
