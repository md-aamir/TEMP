...
set_attribute -quiet runtime_by_stage { {global_incr_map 1 20 0 8}  {incr_opt 0 20 0 8} } /
...
# BEGIN MSV SECTION
# END MSV SECTION
define_clock -name clk -domain domain_1 -period 1500.0 -divide_period 1 -rise 0 -divide_rise 1 -fall 1 -divide_fall 2 -design /designs/project_top /designs/project_top/ports_in/clk
